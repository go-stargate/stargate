...
> Note: You can use confd without a configuration file. See [Command Line Flags](https://github.com/go-stargate/stargate/third_party/forked/confd/blob/master/docs/command-line-flags.md).
