...
func MakeTLSConfig(configs []*Config) (*tls.Config, error) {
	...
	return &tls.Config{
		...
		// only GetConfigForClient set. https://github.com/go-stargate/stargate/third_party/forked/caddy/pull/2404
...
//
// See https://github.com/go-stargate/stargate/third_party/forked/caddy/issues/1674
