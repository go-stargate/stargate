...
import (
	...
	"github.com/go-stargate/stargate/third_party/forked/caddy"
	"github.com/go-stargate/stargate/third_party/forked/caddy/caddyfile"
	"github.com/go-stargate/stargate/third_party/forked/caddy/caddytls"
	"github.com/go-stargate/stargate/third_party/forked/caddy/telemetry"
	"github.com/mholt/certmagic"
	lumberjack "gopkg.in/natefinch/lumberjack.v2"

	_ "github.com/go-stargate/stargate/third_party/forked/caddy/caddyhttp" // plug in the HTTP server type
...
func getBuildModule() *debug.Module {
	...
	if ok {
		...
		for _, mod := range bi.Deps {
			if mod.Path == "github.com/go-stargate/stargate/third_party/forked/caddy" {
				return mod
			}
		}
	}
