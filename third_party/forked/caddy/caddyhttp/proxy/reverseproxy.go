...
import (
	...
	"github.com/go-stargate/stargate/third_party/forked/caddy/caddyhttp/httpserver"
)
...
// see https://github.com/go-stargate/stargate/third_party/forked/caddy/pull/1112#discussion_r80092582
...
func copyHeader(dst, src http.Header) {
	for k, vv := range src {
		if _, ok := dst[k]; ok {
			...
			// see https://github.com/go-stargate/stargate/third_party/forked/caddy/issues/1086
